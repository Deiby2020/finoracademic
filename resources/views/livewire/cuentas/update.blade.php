    ...
    <div class="modal-dialog" role="document">
       <div class="modal-content">
            ...
            <div class="form-group">
                ...
                <input wire:model="fecha_apertura" type="text" class="form-control" id="fecha_apertura" placeholder="Fecha Apertura">@error('fecha_apertura') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input wire:model="fkid_cliente" type="text" class="form-control" id="fkid_cliente" placeholder="Fkid Cliente">@error('fkid_cliente') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
